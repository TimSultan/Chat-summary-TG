...
BOOT_SPECS: Final[tuple[GearSpec, ...]] = (
    ...
    _spec("bt40", "Берцы с гвоздями в подошве", "Напоминания копятся, и уже совсем не маленькие.", "boots", "legendary", (("strength", 8), ("luck", 6), ("armor", -3)), _effect("bleed", "Каждое попадание добавляет кровотечение: 5 урона за раунд, стакается сильнее.", 5)),
)
...
GLOVE_SPECS: Final[tuple[GearSpec, ...]] = (
    ...
    _spec("gl30", "Рукавицы повелителя банок", "Открывают крышки, двери и второй удар подряд.", "gloves", "legendary", (("strength", 9), ("armor", 6), ("agility", -3)), _effect("echo_strike", "Первое попадание повторяется эхом на 200% нанесённого урона.", 200)),
