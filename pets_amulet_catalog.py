...
_DATA: Final = (
    ...
    ("amulet_sour_candy", "Кислая конфета возмездия", "Язык помнит, враг тоже.", "uncommon", {"luck": 3}, _effect("poison", "Каждое попадание: 15 урона в следующий ход соперника.", 15), 24, 12),
    ...
    ("amulet_angry_sponge", "Губка с характером", "Впитывает удар и злится.", "uncommon", {"health": 3}, _effect("retaliation", "После каждого пропущенного удара: +8 урона следующей атаке.", 8), 24, 12),
