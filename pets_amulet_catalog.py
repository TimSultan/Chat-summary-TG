...
_DATA: Final = (
    ...
    ("amulet_sour_candy", "Кислая конфета возмездия", "Язык помнит, враг тоже.", "uncommon", {"luck": 3}, _effect("poison", "Отравляет на 12% урона к следующему ходу соперника, и его атака слабее на 15%.", 12, weaken=15), 24, 12),
    ...
    ("amulet_angry_sponge", "Губка с характером", "Впитывает удар и злится.", "uncommon", {"health": 3}, _effect("retaliation", "После каждого пропущенного удара следующая атака сильнее на 15%.", 15), 24, 12),
