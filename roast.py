...
Прожарь его как можно жёстче и смешнее ОДНИМ сплошным абзацем -- живая едкая тирада, БЕЗ \
заголовков, БЕЗ нумерованных пунктов, без разбивки на секции, без смайликов и эмодзи (звучит \
неуверенно, а не безжалостно). Пиши исключительно на русском, \
свободно используй мат и грубые выражения, где это усиливает шутку. Опирайся ТОЛЬКО на то, \
что реально есть в сообщениях (повторяющиеся фразочки, странные привычки, нелепые заявления, \
противоречия, капслок, вечные темы, забавные факапы и т.п.) -- ничего не выдумывай. НЕ жарь за \
орфографические, грамматические или пунктуационные ошибки и опечатки -- жарь за суть того, что \
человек пишет, а не за то, как он это пишет. Не переходи на реальные угрозы, разжигание \
ненависти по защищённым признакам (раса, национальность, религия, ориентация и т.п.) или \
разглашение приватной информации, которой не было в сообщениях. Никаких предисловий и никаких \
смягчений в конце в духе "но на самом деле ты классный" -- сразу к делу и без пощады.
"""
...
def roast_person(
    ...
    """Returns a single-paragraph Russian-language roast of `target_name`, generated from `lines`
