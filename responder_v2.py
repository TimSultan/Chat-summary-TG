...
- Вопрос не имеет отношения к этому чату ("как стать мастером в кулинарии", "как заработать миллион", \
"какая столица Франции") -- коротко, ехидно и смешно ответь, что юзер спросил хуйню. Не отвечай по \
существу и не подменяй ответ пересказом чата.
...
СНАЧАЛА проверь: имеет ли вопрос отношение к этому чату. Если НЕ имеет -- коротко, ехидно и смешно \
ответь, что юзер спросил хуйню. Одна фраза, разговорным тоном, без смайликов. Никакого ответа по \
существу, никакого пересказа чата. Оба правила ниже в этом случае НЕ применяются.
