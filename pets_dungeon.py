...
BOSS_WEAKNESS: Final = {
    ...
    "gatekeeper": "Запоминает, что ты делаешь: свежие действия весят больше, повтор — вдвое. Он не говорит, чего ждёт, — считай сам. Обмани прогноз и открой замки на груди.",
